...
'''def test_delete_coupon(self):
        ...
        uses_per_cust_dropdown.click()
        unlimited_select = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("Unlimited")')))
        ...
        create_button.click()
        coupon_select = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("DELCOUPON")')))
        coupon_select.click()
        sleep(3)
        self.driver.swipe(470, 760, 470, 66, 400)
        sleep(3)
        delete_coupon = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/deleteCouponTV")))
        delete_coupon.click()
...
def test_create_discount_coupon_as_flat_discount(self):
        ...
        create_coupon_button = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/action_btn")))
        create_coupon_button.click()
        select_discount_type = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("Flat discount")')))
        select_discount_type.click()
        coupon_code_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/coupon_code_et")))
        coupon_code_textbox.send_keys(coupon_code)
        uses_per_cust_dropdown = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/user_per_cust_spinner")))
        uses_per_cust_dropdown.click()
        only_once_select = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("Only once")')))
        only_once_select.click()
        discount_amount_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/flat_discount_value_et")))
        discount_amount_textbox.send_keys("50")
        min_order_amount_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/flat_min_order_value_et")))
...
def test_create_discount_coupon_as_buy_x_get_y(self):
        ...
        unlimited_select = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("Unlimited")')))
        unlimited_select.click()
        buy_x = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/editTextBuy")))
        buy_x.send_keys("2")
        get_y = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/editTextGet")))
        get_y.send_keys("1")
        coupon_apply_on = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/couponOptionTv")))
        coupon_apply_on.click()
        all_products_select = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("All products")')))
...
def test_my_customers_valid_search(self):
        ...
        manage_icon = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.TextView").text("Manage")')))
        manage_icon.click()
        my_customers_icon = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.XPATH, '(//android.widget.ImageView[@content-desc="Small Icon"])[4]')))
        my_customers_icon.click()
        search_icon = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.XPATH, "com.dukaan.app:id/search_icon")))
        search_icon.click()
...
'''def test_add_customer(self):
        ...
        my_customers_icon = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.XPATH, '(//android.widget.ImageView[@content-desc="Small Icon"])[4]')))
        my_customers_icon.click()
        add_customer_button = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/action_btn")))
        add_customer_button.click()
        text_name = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,"android:id/text1")))
        text_name.click()
        name_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/customer_name_et")))
        name_textbox.clear()
    ...
    def random_mobile_number(n):
        ...
        sleep(1)
        mobile_number_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/customer_mobile_et")))
        mobile_number_textbox.clear()
        mobile_number_textbox.send_keys(random_mobile_number(10))
        customer_add_button = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/tv_yes")))
        ...
        search_icon.click()
        search_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/search_et")))
        search_textbox.send_keys(customer_name)
        name_in_customers_page = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, "com.dukaan.app:id/titleTV")))
