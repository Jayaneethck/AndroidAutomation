...
class ManageStorePage(unittest.TestCase):
    ...
    def test_marketing_designs_page(self):
        ...
        sleep(5)
        manage_icon = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Manage")')
        manage_icon.click()
        sleep(3)
        marketing_designs_icon = self.driver.find_element_by_xpath('(//android.widget.ImageView[@content-desc="Small Icon"])[1]')
        marketing_designs_icon.click()
        sleep(3)

        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Business Card")')
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Store Banners")')
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("WhatsApp Stories")')
    ...
    def test_whatsapp_stories(self):
        ...
        marketing_designs_icon.click()
        sleep(2)
        whatsapp_stories_icon = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("WhatsApp Stories")')
        whatsapp_stories_icon.click()
        sleep(2)
        edit_text_button_whatsapp = self.driver.find_element_by_id("com.dukaan.app:id/edit_btn")
        edit_text_button_whatsapp.click()
        sleep(2)
        footer_text = self.driver.find_element_by_id("com.dukaan.app:id/id_et_footer")
        footer_text.send_keys("SHOP ONLINE FROM DUKAAN TEST FOOTER")
        sleep(2)
        save_button = self.driver.find_element_by_id("com.dukaan.app:id/id_btn_save")
        save_button.click()
        sleep(2)
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("SHOP ONLINE FROM DUKAAN TEST FOOTER")')
    ...
    def test_create_discount_coupon_as_percentage(self):
        ...
        sleep(1)
        custom_select = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Custom")')
        custom_select.click()
        sleep(1)
        uses_per_cust_textbox = self.driver.find_element_by_id("com.dukaan.app:id/user_per_cust_cstom_et")
        uses_per_cust_textbox.send_keys("50")
        percent_textbox = self.driver.find_element_by_id("com.dukaan.app:id/percent_discount_value_et")
        percent_textbox.send_keys("20")
        min_order_amount = self.driver.find_element_by_id("com.dukaan.app:id/min_order_value_et")
        min_order_amount.send_keys("300")
        max_discount_amount_textbox = self.driver.find_element_by_id("com.dukaan.app:id/maximum_discount_et")
        max_discount_amount_textbox.send_keys("100")
        self.driver.swipe(542, 1666, 542, 1000, 400)
        sleep(1)
        coupon_functionality = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Coupon functionality")')
        coupon_functionality.click()
        sleep(1)
        show_coupon_to_customer_toggle = self.driver.find_element_by_id("com.dukaan.app:id/switch_show_cust")
        show_coupon_to_customer_toggle.click()
        sleep(1)
        valid_for_online_payments_toggle = self.driver.find_element_by_id("com.dukaan.app:id/switch_valid_online")
        valid_for_online_payments_toggle.click()
        sleep(1)
        coupon_validity = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Coupon validity")')
        coupon_validity.click()
        sleep(1)
        start_date = self.driver.find_element_by_id("com.dukaan.app:id/date_from")
        start_date.click()
        sleep(1)
        month_navigation = self.driver.find_element_by_id("android:id/next")
        month_navigation.click()
        sleep(1)
        start_date_selection = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.view.View").text("1")')
        start_date_selection.click()
        sleep(1)
        select_time = self.driver.find_element_by_id("com.dukaan.app:id/time_from")
        select_time.click()
        done_button = self.driver.find_element_by_id("com.dukaan.app:id/timeDone")
        done_button.click()
        sleep(1)
        create_button = self.driver.find_element_by_id("com.dukaan.app:id/createCouponButton")
        create_button.click()
        sleep(5)
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("PERCOUPON")')
    ...
    def test_delete_coupon(self):
        ...
        manage_icon.click()
        sleep(2)
        discount_coupons_icon = self.driver.find_element_by_xpath(
            '(//android.widget.ImageView[@content-desc="Small Icon"])[3]')
        discount_coupons_icon.click()
        sleep(2)
        create_coupon_button = self.driver.find_element_by_android_uiautomator(
            'new UiSelector().className("android.widget.TextView").text("Create coupon")')
        create_coupon_button.click()
        sleep(2)
        select_discount_type = self.driver.find_element_by_android_uiautomator(
            'new UiSelector().className("android.widget.TextView").text("Percentage discount")')
        ...
        self.driver.swipe(542, 1666, 542, 1000, 400)
        sleep(1)
        coupon_functionality = self.driver.find_element_by_android_uiautomator(
        ...
        create_button.click()
        sleep(2)
        coupon_select = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("DELCOUPON")')
        coupon_select.click()
        sleep(1)
        self.driver.swipe(470, 760, 470, 66, 400)
        sleep(1)
        delete_coupon = self.driver.find_element_by_id("com.dukaan.app:id/deleteCouponTV")
        delete_coupon.click()
        sleep(1)
        ...
        sleep(3)
        try:
            self.assertEqual(self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("DELCOUPON")').is_displayed(), True)
