...
class HomePage(unittest.TestCase):
    ...
    def test_store_views(self):
        ...
        sleep(1)
        try:
            assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("What are Store Views?")')
        except Exception as e:
    ...
    def test_dukaan_status(self):
        ...
        sleep(1)
        go_online_tomorrow_same_time = self.driver.find_element_by_id("com.dukaan.app:id/rb4")
        go_online_tomorrow_same_time.click()
        sleep(2)
        confirm_button = self.driver.find_element_by_id("com.dukaan.app:id/action_btn")
        confirm_button.click()
        sleep(2)
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.Switch").checked(false)')
        sleep(2)
        dukaan_status_toggle.click()
        sleep(2)
        try:
            assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.Switch").checked(true)')
        except Exception as e:
