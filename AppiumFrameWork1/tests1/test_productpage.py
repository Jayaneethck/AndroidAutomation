...
class ProductsPage(unittest.TestCase):
    ...
    def test_add_products(self):
        ...
        products_icon.click()
        sleep(2)
        add_product_button = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Add new product")')
        ...
        choose_category = self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Test Category")')
    ...
    def test_delete_product(self):
        ...
        sleep(2)
        product_select = self.driver.find_element_by_android_uiautomator(
        ...
        delete_product_in_product_details = self.driver.find_element_by_id("com.dukaan.app:id/tvDeleteProduct")
        delete_product_in_product_details.click()
        sleep(2)
        confirm_delete = self.driver.find_element_by_id("com.dukaan.app:id/consentActionTV")
        confirm_delete.click()
        sleep(2)
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.TextView").text("Product deleted successfully")')
    ...
    def test_add_product_with_multiple_categories(self):
        ...
        product_select.click()
        sleep(2)
        assert self.driver.find_element_by_android_uiautomator('new UiSelector().className("android.widget.EditText").text("Test Category, Food Items")')
    ...
    def test_price_validation(self):
        ...
        sleep(2)
        continue_with_email_button = self.driver.find_element_by_android_uiautomator(
            'new UiSelector().className("android.widget.TextView").texxt("Continue with Email")')
        continue_with_email_button.click()
        sleep(1)
        email_address_textbox = self.driver.find_element_by_id("com.dukaan.app:id/et_input")
        email_address_textbox.send_keys("cojeret739@kuruapp.com")
