...
class ProductsPage(unittest.TestCase):
    ...
    def test_delete_product(self):
        ...
        add_button = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,"com.dukaan.app:id/addUpdateProductButton")))
        add_button.click()
        back_button = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,"//android.widget.ImageButton[@content-desc='Navigate up']")))
        back_button.click()
        search_icon = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,"com.dukaan.app:id/search_icon")))
        search_icon.click()
        search_textbox = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,"com.dukaan.app:id/search_et")))
        search_textbox.send_keys("Product to be deleted")
        product_select = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID, 'new UiSelector().className("android.widget.TextView").text("Product to be deleted")')))
        product_select.click()
        self.driver.swipe(500, 1550, 500, 250, 500)
        delete_product_in_product_details = WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,"com.dukaan.app:id/tvDeleteProduct")))
        ...
        assert WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable((AppiumBy.ID,'new UiSelector().className("android.widget.TextView").text("Delete this product")')))
